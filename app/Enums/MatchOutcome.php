 ...
 *
 * Resolution rules (in `GameMatchController::resolveBothConfirmed`):
 *   - Mirror Won/Lost (one Won + one Lost) → settle, winner picked.
 *   - Both Drawn → settle as draw via `MatchSettlement::settleDraw` (refund
 *     both stakes, no winner, no platform fee).
