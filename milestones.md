...
**▶ M46 COMPLETE** except the post-launch P1 audit (needs real production traffic to tune). All buildable chess-hardening phases (P2–P5) shipped 2026-07-07 on branch `feat/m46-chess-disambiguation` (P3–P5 uncommitted — user commits).
