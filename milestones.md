...
**▶ Phase status:** P1 ⏸️ (deferred → post-launch: audit is meaningless without real traffic) · **P2 ✅ DONE (2026-07-07, committed)** · **P3 ✅ DONE (2026-07-07)** · P4 ⬜ · P5 ⬜
**▶ NEXT for M46: P4 (player-guidance UX)** — pure FE/copy, buildable now. P1 audit wants real production traffic, so it waits until after launch.
...
- **P4 — Player guidance UX.** Match page tells players exactly what to do ("play ONE rated {time_control} game vs {opponent}, starting now") so the finder has an unambiguous target — reduces ambiguity at the source, no orchestration / paste needed.
